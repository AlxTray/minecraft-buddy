...
public final class AIResponseHandler {
    ...
    private AIResponseHandler() {
    }

    public static AIResponseHandler getInstance() {
    ...
    private static class LazyHolder {
        private static final AIResponseHandler INSTANCE = new AIResponseHandler();
    }
}
